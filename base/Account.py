...
class Account(KBEngine.Proxy):
    ...
    def give_gold(self, _args):
        ...
        player_gold = tea_house_entity.get_tea_house_player(playerId).game_coin
    ...
    def get_down_proxy_performance_info(self, _args):
        """
        获取下级代理保险箱信息
        :param _args:
        :return:
        ...
        def on_success(info):
            self.call_client_func('GetDownProxyPerformanceInfo', {'info': info})
