...
class Account(KBEngine.Proxy):
    ...
    def clientToBase(self, jsonData):
        ...
        # 请求钻石价值
            ...
            DEBUG_MSG('commission-------------:%s' % surplus_commission)
