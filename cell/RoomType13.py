...
class RoomType13(RoomBase):
    ...
    def send_hand_cards_to_player(self):
        ...
        # all_cards[0] = [4.2, 4.1, 4.3, 4.1, 7.1, 7.2, 7.3, 9.1, 9.2, 9.3, 10.1, 11.1, 11.2, 11.3, 13.1, 13.2]
        # all_cards[1] = [4.2, 4.1, 4.3, 4.1, 7.1, 7.2, 7.3, 9.1, 9.2, 9.3, 10.1, 11.1, 11.2, 11.3, 13.1, 13.2]
        # all_cards[2] = [14.1, 14.2, 13.1, 12.1, 12.2, 8.1, 8.2, 7.1, 6.1, 6.2, 5.1, 5.2, 5.3, 5.4, 3.1, 3.2]
